...
export let game = {
  ...
  sabotageCoins: 0,
  achievement: [
    // ADD THESE ACHIEVEMENTS TO game.achievement
    // (keeps all existing ones – this brings the total to 30)

    {
      ...
      operator: ">=",
      value: 10,
      message: "Tout commence par une première lettre.",
      active: 0,
    },
    {
      label: "Votre premier TEK1",
      watch: "lutins",
      operator: ">=",
      value: 1,
      message: "Un TEK1 motivé vaut mille promesses.",
      active: 0,
    },
    {
      label: "Main-d'œuvre organisée",
      watch: "lutins",
      operator: ">=",
      value: 10,
      message:
        "Une véritable chaîne de production se met en place à partir de 10 TEK1",
      active: 0,
    },
    {
      label: "Argent facile",
      ...
      operator: ">=",
      value: 10000,
      message: "Les premiers vrais bénéfices tombent.",
      active: 0,
    },
    {
      label: "Millionnaire",
      ...
      operator: ">=",
      value: 1000000,
      message: "L'argent n'est plus un problème.",
      active: 0,
    },
    {
      label: "Machine bien huilée",
      watch: "elfEfficiency",
      operator: ">=",
      value: 2,
      message: "Les elfes travaillent plus vite que jamais.",
      active: 0,
    },
    {
      label: "Marketing agressif",
      watch: "upgrades.marketing.instagroom.current",
      operator: ">=",
      value: 3,
      message: "Les réseaux sociaux s'emballent.",
      active: 0,
    },
    {
      label: "Publicité moderne",
      watch: "upgrades.marketing.AIadd.current",
      operator: "==",
      value: 1,
      message: "L'IA sait convaincre les enfants.",
      active: 0,
    },
    {
      label: "Placards bien remplis",
      watch: "upgrades.marketing.skeletonsCloset.current",
      operator: ">=",
      value: 1,
      message: "Certains secrets auraient dû rester cachés.",
      active: 0,
    },
    {
      label: "Corruption douce",
      watch: "upgrades.marketing.bribe.current",
      operator: "==",
      value: 1,
      message: "L'éducation nationale regarde ailleurs.",
      active: 0,
    },
    {
      label: "Service RH exemplaire",
      watch: "upgrades.rh.marketingUpgrade.current",
      operator: ">=",
      value: 1,
      message: "Les équipes marketing sont ravies.",
      active: 0,
    },
    {
      label: "Conditions de travail idéales",
      watch: "upgrades.rh.elfSchedule.current",
      operator: ">=",
      value: 3,
      message: "Même les elfes parlent de bien-être.",
      active: 0,
    },
    {
      label: "Espions partout",
      watch: "upgrades.sabotage.sabotageCoin.current",
      operator: ">=",
      value: 3,
      message: "Des yeux et des oreilles partout.",
      active: 0,
    },
    {
      label: "Charbon stratégique",
      watch: "upgrades.sabotage.charbon.current",
      operator: "==",
      value: 1,
      message: "Tous les cadeaux ne font pas plaisir.",
      active: 0,
    },
    {
      label: "Manipulation réussie",
      watch: "upgrades.sabotage.corruption.current",
      operator: "==",
      value: 1,
      message: "Même les lutins peuvent être retournés...",
      active: 0,
    },
    {
      label: "Scandale public",
      watch: "upgrades.sabotage.casserole.current",
      operator: "==",
      value: 1,
      message: "Madame Noël fait la une des journaux.",
      active: 0,
    },
    {
      label: "Sabotage professionnel",
      watch: "sabotages",
      operator: ">=",
      value: 10,
      message: "Le chaos est maîtrisé.",
      active: 0,
    },
    {
      label: "Empire de Noël",
      watch: "enfants",
      operator: ">=",
      value: 500000,
      message: "Même le Père Noël commence à s'inquiéter.",
      active: 0,
    },
